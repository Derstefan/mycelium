...
import { encodeRuleSetCompact, decodeRuleSetCompact, generateRuleSetCycle } from "./rules";
...
export class ShroomsConfig {
  constructor(allElements, numberOfShrooms, numberOfRules, seed) {
    ...
    for (let i = 0; i < numberOfShrooms; i++) {
      ...
      this.shrooms.push(generateRuleSetCycle(numberOfRules, allElements.length, s));
